...
class StudentGuardian(Base):
    ...
    primary_phone = Column(String, nullable=True, default="N/A")
...
class Student(Base):
    ...
    bece_index_number = Column(String(64), unique=True, index=True, nullable=True)
    enrolment_code = Column(String(64), unique=True, index=True, nullable=True)
